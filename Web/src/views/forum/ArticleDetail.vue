    ...
    >
      <div class="article-detail">
        ...
        <div class="user-info">
          ...
          <div class="user-info-detail">
            <router-link class="nick-name" :to="`/user/${articleInfo.userId}`">
      ...
      <div class="attachment-panel" v-if="attachment" id="view-attachment">
        ...
        <div class="attachment-info">
          <i class="iconfont icon-folder-zip-fill item"></i>
          <div class="fill-name item">{{ attachment.fileName }}</div>
          <div class="size item">
            {{ proxy.Util.sizeToStr(attachment.fileSize) }}
          </div>
          <div class="item">
  ...
  >
    ...
    >
      <div class="quick-item" @click="doLikeHandler">
        <i :class="['iconfont icon-like-fill', havelike ? 'havelike' : '']"></i>
      </div>
    </el-badge>
    <!-- 评论 -->
    <el-badge
    ...
    >
      <div class="quick-item" @click="goToPostion('view-comment')"  v-if="showComment">
        <i class="iconfont icon-comment_fill"></i>
      </div>
    </el-badge>
    <!-- 附件 -->
...
const goToPostion = (domId) => {
  if (domId != "view-comment") {
    document.querySelector("#" + domId).scrollIntoView({ block: "center" });
  } else {
