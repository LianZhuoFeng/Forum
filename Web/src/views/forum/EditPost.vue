          ...
          <template #header>
            <div class="post-editor-title">
              ...
              <div class="change-editor-type">
                <i class="iconfont icon-exchange" @click="changeEditor">
                  切换为{{
        ...
        <el-card :body-style="{ padding: '5px' }">
          ...
          <div class="setting-inner">
            ...
            <el-form-item label="封面" prop="cover">
              ...
              <i
                v-if="formData.cover"
                class="iconfont icon-closefill"
                @click="removeCoverUploadImg"
              ></i>
            </el-form-item>
            <!--textarea输入-->
...
const rules = {
  ...
  integral: [
    ...
    { validator: proxy.veryfy.number, message: "积分只能是数字" },
  ],
};
...
// 删除图片
const CoverUploadImg = ref(null);
const removeCoverUploadImg = () => {
  CoverUploadImg.value.localFile = null;
